...
//      Test Muxes                  Off
//
//      Creation Date:  Tue Feb  2 17:28:37 2021
//      Version: 	r0p0
//
...
`celldefine
`ifdef POWER_PINS
module RF1_512_32 (Q, CLK, CEN, WEN, A, D, VDD, VSS);
`else
module RF1_512_32 (Q, CLK, CEN, WEN, A, D);
`endif
...
`endif
  ...
  reg NOT_D3, NOT_D30, NOT_D31, NOT_D4, NOT_D5, NOT_D6, NOT_D7, NOT_D8, NOT_D9, NOT_WEN;
  reg clk0_int;
  reg CREN_legal;
  initial CREN_legal = 1'b1;
