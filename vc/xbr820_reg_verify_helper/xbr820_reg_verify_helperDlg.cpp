// xbr820_reg_verify_helperDlg.cpp : implementation file
//
...
Cxbr820_reg_verify_helperDlg::Cxbr820_reg_verify_helperDlg(CWnd* pParent /*=NULL*/)
	: CDialog(Cxbr820_reg_verify_helperDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(Cxbr820_reg_verify_helperDlg)
...
void Cxbr820_reg_verify_helperDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(Cxbr820_reg_verify_helperDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(Cxbr820_reg_verify_helperDlg, CDialog)
	//{{AFX_MSG_MAP(Cxbr820_reg_verify_helperDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// Cxbr820_reg_verify_helperDlg message handlers

BOOL Cxbr820_reg_verify_helperDlg::OnInitDialog()
{
...
void Cxbr820_reg_verify_helperDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void Cxbr820_reg_verify_helperDlg::OnPaint() 
{
	if (IsIconic())
	{
...
HCURSOR Cxbr820_reg_verify_helperDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

int Cxbr820_reg_verify_helperDlg::test_memory( struct target *target )
{
...
void Cxbr820_reg_verify_helperDlg::OnButton1() 
{
...
void Cxbr820_reg_verify_helperDlg::PostNcDestroy() 
{
...
void Cxbr820_reg_verify_helperDlg::OnClose() 
{
...
void Cxbr820_reg_verify_helperDlg::init_timer()
{
	SetTimer(0, 200, NULL);	//200ms一次
}

void Cxbr820_reg_verify_helperDlg::init_thread()
{
	CString	thread_str;
...
void Cxbr820_reg_verify_helperDlg::OnTimer(UINT nIDEvent) 
{
	switch (nIDEvent)
	{
	case 0:
...
UINT Cxbr820_reg_verify_helperDlg::Read_ac( void* p_Param )
{
	Cxbr820_reg_verify_helperApp* global_var = (Cxbr820_reg_verify_helperApp *)AfxGetApp();
	Cxbr820_reg_verify_helperDlg* pThis = (Cxbr820_reg_verify_helperDlg*)p_Param;
...
void Cxbr820_reg_verify_helperDlg::waitThreads()
{
	DWORD thread_status;
...
void Cxbr820_reg_verify_helperDlg::update_var_display()
{
	Cxbr820_reg_verify_helperApp* global_var = (Cxbr820_reg_verify_helperApp *)AfxGetApp();
...
int Cxbr820_reg_verify_helperDlg::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void Cxbr820_reg_verify_helperDlg::OnButton2() 
{
	unsigned int bb_adc_thersh1 = 0;		//距离门限
...
void Cxbr820_reg_verify_helperDlg::OnButton3() 
{
	unsigned int bb_adc_thersh1 = 0;		//距离门限
...
void Cxbr820_reg_verify_helperDlg::OnButton4() 
{
	unsigned int bb_adc_thersh1 = 0;		//距离门限
