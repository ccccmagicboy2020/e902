...
{
	TARGET_CONFIG_FDB = 0,  ///<control whether set FDB when resuming the target
};
...
struct gdb_fileio_info
{
    ...
    unsigned int param_1;   ///< Parameter 1
    unsigned int param_2;   ///< Parameter 2
    unsigned int param_3;   ///< Parameter 3
    unsigned int param_4;   ///< Parameter 4
};
...
struct halt_info
{
    ...
    unsigned int status;                ///< The value of HSR
    union {
...
/**
  \brief        Reset target
  \param[in]    tgt, the handle of target
  \param[in]    hard, is hard-reset or not, 1 hard, 0, software
  \param[in]    data, unused
  \return       zero for success, negative for error
*/
TARGET_API int target_reset (struct target *tgt, int hard, void *data);
...
/**
  ...
  \return       None
*/
TARGET_API void target_print_version(void);
...
/**
  ...
  \return       None
*/
TARGET_API void target_print_arch_info (struct target *tgt);
