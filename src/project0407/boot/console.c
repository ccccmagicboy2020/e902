...
#include "console.h"
...
#ifndef CONFIG_CONSOLE_TXSIZE
 #define CONFIG_CONSOLE_TXSIZE		0
#endif
 ...
 #define CONFIG_CONSOLE_TXTIMEOUT	1
#endif
...
void console_init(void) {
	...
	config.buf = console_buffer;
	config.rsize = CONFIG_CONSOLE_RXSIZE;
